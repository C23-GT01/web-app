...
const AddImpact = ({ move }) => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [fileLocationUpdated, fileLocation, description, name, statusPost, navigate]);
      ...
      {loading ? (
        ...
        <form onSubmit={handleSubmit} className='grid gap-4'>
          <div className="mb-4 md:col-span-2">
            <label htmlFor="fileInput" className="block font-semibold mb-1">Bukti Impact</label>
          ...
          <div className="mb-4 md:col-span-2">
            <label htmlFor="name" className="block font-semibold mb-1 ">Nama Impact</label>
            <input
              type="text"
              id="name"
              value={name}
