...
import { deleteImpact } from "../../services/impact.service";
...
const DeleteImpact = ({
  ...
  const handleDelete = async (slug) => {
    ...
    const res = await deleteImpact(slug);
    if (res) {
      setStatusPost("Berhasil Menghapus Impact");
    } else {
      setStatusPost("Gagal Menghapus Impact");
    }
    setTimeout(() => {
      setLoading(false);
      noClose(false);
