...
const EditTokped = ({ data, refresh, closeModal, noClose }) => {
  const [contact, setContact] = useState({
    name: data.contact.tokped ? data.contact.tokped.name : "",
    url: data.contact.tokped ? data.contact.tokped.url : "",
  });
  ...
  const handleSubmit = async (event) => {
    ...
    if (contact.name === "" && contact.url === "") {
      const { tokped, ...restContact } = data.contact;
      contactData = {
        ...restContact,
      };
    } else {
