...
const EditFacebook = ({ data, refresh, closeModal, noClose }) => {
  const [contact, setContact] = useState({
    name: data.contact.faceBook ? data.contact.faceBook.name : "",
    url: data.contact.faceBook ? data.contact.faceBook.url : "",
  });
  ...
  const handleSubmit = async (event) => {
    ...
    if (contact.name === "" && contact.url === "") {
      const { faceBook, ...restContact } = data.contact;
      contactData = {
        ...restContact,
      };
    } else {
