...
const FooterBox = () => {
    return (
        ...
        <div className="text-left sm:mt-8 sm:mb-4 text-white font-inter grid grid-cols-3 max-w-2xl mx-auto gap-y-2 sm:translate-x-16 p-8 sm:p-0 text-xs sm:text-sm">
            <h3 className="mr-16 font-bold"><a href="">Product</a></h3>
            <h3 className="mr-16 font-bold"><a href="">UMKM</a></h3>
            <h3 className="mr-16 font-bold"><a href="">Contact</a></h3>
            <ul className="text-left text-white font-light ">
                <li>Sambal Baby Cumi</li>
                <li>Sambal Example</li>
                <li>Sambal Contoh</li>
                <li>Sambal Example</li>
                <li>Sambal Contoh</li>
            </ul>
        ...
        <div className="flex max-w-xl text-s">
