...
const CardResource = ({
      ...
      try {
        ...
        if (token) {
          ...
          const response = await axios.delete(
            `https://c23-gt01-01.et.r.appspot.com/resources/${id}`,
            config
          );
  ...
  return (
    <div className="flex flex-col drop-shadow-xl bg-white rounded-2xl">
      <LazyLoadImage
        src={src}
      ...
      <div className="w-64 p-4">
        {edited && (
          <div className="w-full justify-end flex gap-2 py-2">
            ...
            <Icon size="w-6 h-6">
              <MdDelete onClick={(event) => deleteResourceHandle(event, id)} />
            </Icon>
          </div>
        )}
